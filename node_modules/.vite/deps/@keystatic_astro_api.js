...
If you were trying to sign in locally and recently upgraded Keystatic from @keystatic/core@0.0.69 or below, you need to add \`http://127.0.0.1/api/keystatic/github/oauth/callback\` as a callback URL in your GitHub app.` : ""}`
  ...
  const cookies = import_cookie.default.parse((_req$headers$get2 = req.headers.get("cookie")) !== null && _req$headers$get2 !== void 0 ? _req$headers$get2 : "");
...
async function getTokenCookies(tokenData, config) {
  const headers = [["Set-Cookie", import_cookie.default.serialize("keystatic-gh-access-token", tokenData.access_token, {
    ...
    path: "/"
  })], ["Set-Cookie", import_cookie.default.serialize("keystatic-gh-refresh-token", await encryptValue(tokenData.refresh_token, config.secret), {
    sameSite: "lax",
    secure: false,
    httpOnly: true,
...
function makeHandler(_config) {
  ...
  const handler = makeGenericAPIRouteHandler({
    ..._config,
    clientId: (_config$clientId = _config.clientId) !== null && _config$clientId !== void 0 ? _config$clientId : tryOrUndefined2(() => {
      return import.meta.env.KEYSTATIC_GITHUB_CLIENT_ID;
    }),
    clientSecret: (_config$clientSecret = _config.clientSecret) !== null && _config$clientSecret !== void 0 ? _config$clientSecret : tryOrUndefined2(() => {
      return import.meta.env.KEYSTATIC_GITHUB_CLIENT_SECRET;
    }),
    secret: (_config$secret = _config.secret) !== null && _config$secret !== void 0 ? _config$secret : tryOrUndefined2(() => {
