...
import {
  ...
  string,
  type
} from "./chunk-CCJ524AM.js";
import {
  require_jsx_runtime
} from "./chunk-SEHNQLQI.js";
import {
  require_react_dom
} from "./chunk-VPNU7N66.js";
import {
  require_react
...
function $4d52238874b24f86$export$9bb30bbe003b82e0(props, state, inputRef) {
  ...
  }, onClear, type: type3 = "search" } = props;
  let onKeyDown = (e2) => {
    const key = e2.key;
    if (key === "Enter")
      e2.preventDefault();
...
var $a9e7ae544a4e41dd$export$7ff77a162970b30e = class {
  ...
  resizeColumnWidth(tableWidth, collection, controlledWidths, uncontrolledWidths, col = null, width) {
    ...
    collection.columns.forEach((column, i3) => {
      var _column_props_width_endsWith, _column_props_width;
      let frKey;
      let frValue;
      minWidths.set(column.key, this.getDefaultMinWidth(collection.columns[i3]));
    ...
    let columnWidths = (0, $6818b1c4fc67028d$export$55d50dc687385491)(tableWidth, collection.columns.map((col2) => ({
      ...col2.props,
      key: col2.key
    })), resizingChanged, (i3) => this.getDefaultWidth(collection.columns[i3]), (i3) => this.getDefaultMinWidth(collection.columns[i3]));
  ...
  buildColumnWidths(tableWidth, collection, widths) {
    ...
    let columnWidths = (0, $6818b1c4fc67028d$export$55d50dc687385491)(tableWidth, collection.columns.map((col) => ({
      ...col.props,
      key: col.key
    })), widths, (i3) => this.getDefaultWidth(collection.columns[i3]), (i3) => this.getDefaultMinWidth(collection.columns[i3]));
  ...
  for (let column of columnNodes) {
    ...
    while (parentKey) {
      ...
      if (seen.has(parent)) {
        ...
        if (index > col.length)
          break;
        for (let i4 = index; i4 < col.length; i4++)
  ...
  for (let column of columns) {
    ...
    for (let item of column) {
      if (item) {
        ...
        let rowLength = row.reduce((p5, c3) => p5 + c3.colspan, 0);
...
function $4a0dd036d492cee4$export$907bcc6c48325fd6(props) {
  ...
  let collection = (0, $7613b1592d41b092$export$6cd28814d92fa9c9)(props, (0, import_react4.useCallback)((nodes) => new (0, $788781baa30117fa$export$596e1b2e2cf93690)(nodes, null, context), [
    context
  ]), context);
...
$312ae3b56a94a86e$var$TableHeader.getCollectionNode = function* getCollectionNode(props, context) {
  ...
  if (typeof children === "function") {
    ...
    let columns2 = [];
    (0, import_react5.default).Children.forEach(children, (column) => {
      columns2.push({
        type: "column",
        element: column
      });
  ...
  yield {
    ...
    *childNodes() {
      if (typeof children === "function") {
        ...
        let items2 = [];
        (0, import_react6.default).Children.forEach(children, (item) => {
          items2.push({
            type: "item",
            element: item
          });
...
$1cd244557c2f97d5$var$Column.getCollectionNode = function* getCollectionNode3(props, context) {
  ...
  let fullNodes = yield {
    type: "column",
    hasChildNodes: !!childColumns || title && (0, import_react7.default).Children.count(children) > 0,
    rendered,
    textValue,
    props,
    *childNodes() {
  ...
  yield {
    ...
    *childNodes() {
      ...
      if (typeof children === "function") {
        ...
        let cells = [];
        let childRows = [];
        (0, import_react8.default).Children.forEach(children, (node) => {
    ...
    shouldInvalidate(newContext) {
      return newContext.columns.length !== context.columns.length || newContext.columns.some((c3, i3) => c3.key !== context.columns[i3].key) || newContext.showSelectionCheckboxes !== context.showSelectionCheckboxes || newContext.showDragButtons !== context.showDragButtons || newContext.selectionMode !== context.selectionMode;
    }
  };
};
...
function $6e31608fbba75bab$export$25bceaac3c7e4dc7(props, state, ref) {
  ...
  let delegate = (0, import_react10.useMemo)(() => keyboardDelegate || new (0, $0ba3c81c7f1caedd$export$da43f8f5cb04028d)({
...
var TableContext = (0, import_react13.createContext)(null);
function useTableContext() {
  return (0, import_react13.useContext)(TableContext);
}
function TableView(props) {
  let domRef = (0, import_react13.useRef)(null);
  let headerRef = (0, import_react13.useRef)(null);
  let bodyRef = (0, import_react13.useRef)(null);
  let {
    direction
  } = $18f2051aff69b9bf$export$43bb16f9c6d9e3f7();
  ...
  const getDefaultWidth = (0, import_react13.useCallback)(({
    props: {
      hideHeader,
      isSelectionCell
    }
  ...
  const getDefaultMinWidth = (0, import_react13.useCallback)(({
    props: {
      hideHeader,
      isSelectionCell
    }
  ...
  let columnLayout = (0, import_react13.useMemo)(() => new $a9e7ae544a4e41dd$export$7ff77a162970b30e({
    getDefaultWidth,
    getDefaultMinWidth
  }), [getDefaultWidth, getDefaultMinWidth]);
  const [initialCollection] = (0, import_react13.useState)(state.collection);
  let tableLayout = (0, import_react13.useMemo)(() => new $a152112e902709bf$export$62444c3c724b1b20({
  ...
  let layout = (0, import_react13.useMemo)(() => {
...
function TableVirtualizer(props) {
  ...
  let syncScroll = (0, import_react13.useCallback)(() => {
    let bodyEl = bodyRef.current;
  ...
  let scrollToItem = (0, import_react13.useCallback)((key) => {
    let item = collection.getItem(key);
  ...
  let memoedVirtualizerProps = (0, import_react13.useMemo)(() => ({
    scrollToItem,
    isLoading,
    onLoadMore
...
var TableHeaderWrapper = (0, import_react13.forwardRef)(function TableHeaderWrapper2(props, ref) {
    ...
    for (i3 = 0; i3 < string2.length; char >= 65536 ? i3 += 2 : i3++) {
      ...
      if (char === CHAR_LINE_FEED) {
        ...
        if (shouldTrackWidth) {
          ...
          i3 - previousLineBreak - 1 > lineWidth && string2[previousLineBreak + 1] !== " ";
...
function escapeString(string2) {
  ...
  var char = 0;
  var escapeSeq;
  for (var i3 = 0; i3 < string2.length; char >= 65536 ? i3 += 2 : i3++) {
    char = codePointAt(string2, i3);
...
// node_modules/@keystatic/core/dist/required-files-94f5a8ea.js
...
function loadDataFile(data, formatInfo) {
  const parse2 = formatInfo.data === "json" ? JSON.parse : load;
  if (!formatInfo.contentField) {
    const dataFile = textDecoder.decode(data);
    return {
      loaded: parse2(dataFile)
    };
  }
  const res = splitFrontmatter(data);
  return {
    loaded: res === null ? {} : parse2(res.frontmatter),
    extraFakeFile: {
...
function Notice(props) {
  ...
  return (0, import_jsx_runtime13.jsxs)(Grid, {
    "aria-live": "polite",
    ...
    children: [(0, import_jsx_runtime13.jsx)(Icon, {
      ...
      gridArea: "icon",
      alignSelf: "start"
    }), (0, import_jsx_runtime13.jsx)(SlotProvider, {
      slots,
      children: isReactText(children) ? (0, import_jsx_runtime13.jsx)(Content, {
...
function $848231d7a2b3998e$export$8cefe241bd876ca0(props) {
  ...
  let strings = (0, $fca6afa0e843324b$export$f12b703ca79dfbb1)((0, $parcel$interopDefault5($8229b34715874f89$exports)), "@react-aria/breadcrumbs");
  return {
    navProps: {
...
var folderClosedIcon = (0, import_jsx_runtime15.jsx)("path", {
...
var folderOpenIcon = (0, import_jsx_runtime16.jsx)("path", {
...
function BreadcrumbItem(props) {
  ...
  let icon = (0, import_react15.useMemo)(() => {
    return direction === "rtl" ? chevronLeftIcon : chevronRightIcon;
  }, [direction]);
  if (isMenu) {
    itemProps = {};
  }
  return (0, import_jsx_runtime17.jsxs)(import_react15.Fragment, {
    children: [(0, import_jsx_runtime17.jsx)(FocusRing, {
      children: (0, import_jsx_runtime17.jsx)(ElementType, {
    ...
    }), !isCurrent && (0, import_jsx_runtime17.jsx)(Icon, {
      src: icon,
...
function Breadcrumbs(props, ref) {
  ...
  let listRef = (0, import_react15.useRef)(null);
  let [menuIsOpen, setMenuOpen] = (0, import_react15.useState)(false);
  ...
  let updateOverflow = (0, import_react15.useCallback)(() => {
  ...
  let lastChildren = (0, import_react15.useRef)(null);
  $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c(() => {
  ...
  if (childArray.length > visibleItems) {
    ...
    let menuItem = (0, import_jsx_runtime17.jsx)(BreadcrumbItem, {
      isMenu: true,
      children: (0, import_jsx_runtime17.jsxs)(MenuTrigger, {
        onOpenChange: setMenuOpen,
        children: [(0, import_jsx_runtime17.jsx)(ActionButton, {
          "aria-label": "…",
          prominence: "low",
          isDisabled,
          children: (0, import_jsx_runtime17.jsx)(Icon, {
            src: menuIsOpen ? folderOpenIcon : folderClosedIcon
          })
        }), (0, import_jsx_runtime17.jsx)(_Menu, {
  ...
  let breadcrumbItems = contents.map((child, index) => {
    ...
    return (0, import_jsx_runtime17.jsx)("li", {
      ...
      children: (0, import_react15.createElement)(BreadcrumbItem, {
        ...child.props,
        isCurrent,
        isDisabled,
        key,
  ...
  return (0, import_jsx_runtime17.jsx)("nav", {
    ...navProps,
    ...styleProps,
    ref: domRef,
    className: classNames(breadcrumbsClassList.element("root"), styleProps.className),
    children: (0, import_jsx_runtime17.jsx)("ul", {
      ref: listRef,
...
var _Breadcrumbs = (0, import_react15.forwardRef)(Breadcrumbs);

// node_modules/@urql/core/dist/urql-core-chunk.mjs
var phash = (e2, r3) => {
  var t = 0 | (r3 || 5381);
  for (var a = 0, o = 0 | e2.length; a < o; a++) {
    t = (t << 5) + t + e2.charCodeAt(a);
  }
  return t;
};
...
var stringify = (e2) => {
  ...
  var a = Object.keys(e2).sort();
  if (!a.length && e2.constructor && Object.getPrototypeOf(e2).constructor !== Object.prototype.constructor) {
    var o = f2.get(e2) || Math.random().toString(36).slice(2);
    f2.set(e2, o);
    return stringify({
      __key: o
    });
...
var d = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g;
var v = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g;
var replaceOutsideStrings = (e2, r3) => r3 % 2 == 0 ? e2.replace(v, "\n") : e2;
...
var stringifyDocument = (e2) => {
  var t;
  if ("string" == typeof e2) {
    t = sanitizeDocument(e2);
  } else if (e2.loc && u.get(e2.__key) === e2) {
    t = e2.loc.source.body;
  } else {
    t = p.get(e2) || sanitizeDocument(print(e2));
    p.set(e2, t);
  }
...
var hashDocument = (e2) => {
  var r3 = phash(stringifyDocument(e2));
  if (e2.definitions) {
    var t = getOperationName(e2);
    if (t) {
      r3 = phash(`
# ${t}`, r3);
    }
...
var createRequest = (e2, r3, t) => {
  var a = r3 || {};
  var o = keyDocument(e2);
...
var formatNode = (r3) => {
  ...
  if ("selectionSet" in r3) {
    var u4 = [];
    var p5 = r3.kind === e.OPERATION_DEFINITION;
    if (r3.selectionSet) {
      for (var d5 of r3.selectionSet.selections || []) {
        p5 = p5 || d5.kind === e.FIELD && "__typename" === d5.name.value && !d5.alias;
        var v4 = formatNode(d5);
        u4.push(v4);
      }
      if (!p5) {
        u4.push({
...
function makeOperation(e2, r3, t) {
  return {
    ...r3,
    kind: e2,
    context: r3.context ? {
...
function invariant(e2, r3, t) {
  if (!e2) {
    ...
    var i3 = new Error(a + h + t);
    i3.name = "Graphcache Error";
    throw i3;
  }
}
...
var getFieldArguments = (e2, r3) => {
  var t = null;
  if (e2.arguments) {
    for (var a = 0, i3 = e2.arguments.length; a < i3; a++) {
...
var filterVariables = (e2, r3) => {
  ...
  var t = {};
  for (var a = 0, i3 = e2.variableDefinitions.length; a < i3; a++) {
...
var shouldInclude = (e2, r3) => {
  ...
  if (t.include || t.skip) {
    for (var a in t) {
      var i3 = t[a];
      if (i3 && ("include" === a || "skip" === a) && i3.arguments && i3.arguments[0] && "if" === getName(i3.arguments[0])) {
        var n = valueFromASTUntyped(i3.arguments[0].value, r3);
...
var isFieldNullable = (e2, r3, t, a) => {
  var i3 = getField(e2, r3, t, a);
  return !!i3 && "NON_NULL" !== i3.type.kind;
};
var isListNullable = (e2, r3, t, a) => {
  ...
  var n = "NON_NULL" === i3.type.kind ? i3.type.ofType : i3.type;
...
var getField = (e2, r3, t, a) => {
  ...
  var i3 = e2.types.get(r3).fields()[t];
  if (true) {
    if (!i3) {
...
var initDataState = (e2, r3, t, a, i3) => {
...
var setNode = (e2, r3, t, a) => {
  ...
  var i3 = b ? e2.optimistic.get(b) : e2.base;
  var n = i3.get(r3);
  if (void 0 === n) {
    i3.set(r3, n = /* @__PURE__ */ Object.create(null));
  }
  if (void 0 === a && !b) {
    delete n[t];
  } else {
...
var getNode = (e2, r3, t) => {
  var a;
  var i3 = !I2 && "read" === D && b && w.commutativeKeys.has(b);
  for (var n = 0, o = w.optimisticOrder.length; n < o; n++) {
    var s = w.optimisticOrder[n];
    var l3 = e2.optimistic.get(s);
    i3 = i3 && s !== b;
    if (l3 && (!i3 || !w.commutativeKeys.has(s)) && (!I2 || "write" === D || w.commutativeKeys.has(s)) && void 0 !== (a = l3.get(r3)) && t in a) {
      return a[t];
    }
  }
...
var extractNodeMapFields = (e2, r3, t, a) => {
  ...
  for (var i3 = 0, n = w.optimisticOrder.length; i3 < n; i3++) {
    var o = a.optimistic.get(w.optimisticOrder[i3]);
    if (void 0 !== o) {
...
var gc = () => {
  ...
  for (var e2 of w.gc.keys()) {
    ...
    var i3 = w.links.base.get(e2);
    if (i3) {
      w.links.base.delete(e2);
      for (var n in i3) {
        updateRCForLink(i3[n], -1);
      }
    }
  }
};
...
var squashLayer = (e2) => {
  ...
  if (s) {
    for (var l3 of s.entries()) {
      var v4 = l3[0];
      var d5 = l3[1];
      for (var u4 in d5) {
        writeRecord(v4, u4, d5[u4]);
      }
    }
  }
  x = r3;
...
var inspectFields = (e2) => {
  ...
  extractNodeMapFields(a, i3, e2, r3);
  extractNodeMapFields(a, i3, e2, t);
  return a;
};
var persistData = () => {
  if (w.storage) {
    ...
    for (var t of w.persist.keys()) {
      var { entityKey: a, fieldKey: i3 } = deserializeKeyInfo(t);
      var n = void 0;
      if (void 0 !== (n = readLink(a, i3))) {
        r3[t] = `:${stringifyVariables(n)}`;
      } else if (void 0 !== (n = readRecord(a, i3))) {
        r3[t] = stringifyVariables(n);
      } else {
        r3[t] = void 0;
      }
...
var makeContext = (e2, r3, t, a, i3, n) => {
  var o = {
    store: e2,
    variables: r3,
    fragments: t,
  ...
  if (n && n.graphQLErrors) {
    for (var s = 0; s < n.graphQLErrors.length; s++) {
      var l3 = n.graphQLErrors[s];
      if (l3.path && l3.path.length) {
        if (!o.__internal.errorMap) {
          o.__internal.errorMap = /* @__PURE__ */ Object.create(null);
        }
        o.__internal.errorMap[l3.path.join(".")] = l3;
      }
    }
  }
  return o;
};
var updateContext = (e2, r3, t, a, i3, n) => {
  S = e2;
  e2.parent = r3;
  e2.parentTypeName = t;
  e2.parentKey = a;
  e2.parentFieldKey = i3;
  e2.fieldName = n;
  e2.error = getFieldError(e2);
};
var isFragmentHeuristicallyMatching = (e2, r3, t, a, i3) => {
  if (!r3) {
    return false;
  }
...
function makeSelectionIterator(e2, r3, t, a, i3, o) {
  var s;
  var l3 = 0;
  return function next() {
    var v4;
    while (s || l3 < i3.length) {
      v4 = void 0;
      T = t;
      A = a;
      if (s) {
        ...
        var d5 = i3[l3++];
        if (!shouldInclude(d5, o.variables)) {
        } else if (d5.kind !== e.FIELD) {
          var u4 = d5.kind !== e.INLINE_FRAGMENT ? o.fragments[getName(d5)] : d5;
          if (u4) {
            if (!u4.typeCondition || (o.store.schema ? isInterfaceOfType(o.store.schema, u4, e2) : isFragmentHeuristicallyMatching(u4, e2, r3, o.variables, o.store.logger))) {
              if (true) {
                pushDebugNode(e2, u4);
              }
              var c3 = isOptional(d5);
              s = makeSelectionIterator(e2, r3, t || isDeferred(d5, o.variables), void 0 !== c3 ? c3 : a, getSelectionSet(u4), o);
            }
          }
        } else if ("write" === D || !d5._generated) {
          return d5;
        }
      }
    }
...
var ensureLink = (e2, r3) => {
  if (!r3) {
    ...
    for (var a = 0, i3 = t.length; a < i3; a++) {
...
var _query = (e2, t, a, i3) => {
  var n = formatDocument(t.query);
  var o = getMainOperation(n);
  var s = e2.rootFields[o.operation];
  var l3 = getSelectionSet(o);
  var v4 = makeContext(e2, normalizeVariables(o, t.variables), getFragments(n), s, s, i3);
  if (true) {
    pushDebugNode(s, o);
  }
  var d5 = s !== v4.store.rootFields.query ? readRoot(v4, s, l3, a || makeData()) : readSelection(v4, s, l3, a || makeData());
  if (true) {
    popDebugNode();
    getCurrentDependencies();
  }
...
var readRoot = (e2, r3, t, a) => {
  ...
  var i3 = makeSelectionIterator(r3, r3, false, void 0, t, e2);
  var n;
  var o = V;
  var s = makeData(a);
  while (n = i3()) {
    var l3 = getFieldAlias(n);
    var v4 = a[l3];
    e2.__internal.path.push(l3);
    var d5 = void 0;
    if (n.selectionSet && null !== v4) {
      d5 = readRootField(e2, getSelectionSet(n), ensureData(v4));
    } else {
      d5 = v4;
    }
    o = o || d5 !== v4;
...
function getFieldResolver(e2, r3, t, a) {
  var i3 = a.store.resolvers[r3];
  var n = i3 && i3[t];
  var o;
  for (var s in e2) {
    var l3 = e2[s];
    if (l3 && "include" !== s && "skip" !== s && a.store.directives[s]) {
      o = a.store.directives[s](getFieldArguments(l3, a.variables));
      if (false) {
        return o;
      }
      break;
...
var readSelection = (e2, r3, t, a, i3) => {
  var { store: n } = e2;
  var o = r3 === n.rootFields.query;
  var s = i3 && n.keyOfEntity(i3) || r3;
  if (true) {
  ...
  var l3 = !o ? readRecord(s, "__typename") || i3 && i3.__typename : r3;
  if ("string" != typeof l3) {
    return;
  } else if (i3 && l3 !== i3.__typename) {
  ...
  var v4 = makeSelectionIterator(l3, s, false, void 0, t, e2);
  var d5 = false;
  var u4 = false;
  var c3 = V;
  var p5;
  ...
  while (void 0 !== (p5 = v4())) {
    var h2 = getName(p5);
    var m2 = getFieldArguments(p5, e2.variables);
    var g2 = getFieldAlias(p5);
    var _2 = getDirectives(p5);
    var N2 = getFieldResolver(_2, l3, h2, e2);
    var k2 = keyOfField(h2, m2);
    var E2 = joinKeys(s, k2);
    var O2 = readRecord(s, k2);
    var w2 = i3 ? i3[h2] : void 0;
    if (n.schema && l3) {
      isFieldAvailableOnType(n.schema, l3, h2, e2.store.logger);
    }
    e2.__internal.path.push(g2);
    var b2 = void 0;
    if ("__typename" === h2) {
      b2 = l3;
    } else if (void 0 !== w2 && void 0 === p5.selectionSet) {
      b2 = w2;
    } else if ("read" === D && N2) {
      var x2 = y4;
      if (void 0 === p5.selectionSet && void 0 !== O2) {
        x2 = {
          ...y4,
          [g2]: O2,
          [h2]: O2
      ...
      updateContext(e2, x2, l3, s, k2, h2);
      b2 = N2(x2, m2 || {}, n, e2);
      if (p5.selectionSet) {
        b2 = resolveResolverResult(e2, l3, h2, E2, getSelectionSet(p5), void 0 !== y4[g2] ? y4[g2] : a[g2], b2, ownsData(a));
      }
      if (n.schema && null === b2 && !isFieldNullable(n.schema, l3, h2, e2.store.logger)) {
        return;
      }
    } else if (!p5.selectionSet) {
      b2 = O2;
    } else if (void 0 !== w2) {
      b2 = resolveResolverResult(e2, l3, h2, E2, getSelectionSet(p5), void 0 !== y4[g2] ? y4[g2] : a[g2], w2, ownsData(a));
    } else {
      var I3 = readLink(s, k2);
      if (void 0 !== I3) {
        b2 = resolveLink(e2, I3, l3, h2, getSelectionSet(p5), void 0 !== y4[g2] ? y4[g2] : a[g2], ownsData(a));
      } else if ("object" == typeof O2 && null !== O2) {
        b2 = O2;
      }
    }
    if (!T && void 0 === b2 && (_2.optional || A && !_2.required || getFieldError(e2) || n.schema && isFieldNullable(n.schema, l3, h2, e2.store.logger))) {
      e2.partial = true;
      b2 = null;
    } else if (null === b2 && (_2.required || false === A)) {
  ...
  e2.partial = e2.partial || f4;
  e2.hasNext = e2.hasNext || u4;
  return o && e2.partial && !d5 ? void 0 : c3 ? y4 : a;
};
var resolveResolverResult = (e2, r3, t, a, i3, n, o, s) => {
  if (Array.isArray(o)) {
    var { store: l3 } = e2;
    var v4 = l3.schema ? isListNullable(l3.schema, r3, t, e2.store.logger) : false;
    var d5 = e2.partial;
    var u4 = makeData(n, true);
    var c3 = V || !Array.isArray(n) || o.length !== n.length;
    for (var p5 = 0, f4 = o.length; p5 < f4; p5++) {
      e2.__internal.path.push(p5);
      var y4 = resolveResolverResult(e2, r3, t, joinKeys(a, `${p5}`), i3, null != n ? n[p5] : void 0, o[p5], s);
      e2.__internal.path.pop();
      if (void 0 === y4 && !v4) {
        e2.partial = d5;
        return;
      } else {
        e2.partial = e2.partial || void 0 === y4 && v4;
        u4[p5] = null != y4 ? y4 : null;
        c3 = c3 || u4[p5] !== n[p5];
      }
    }
    return c3 ? u4 : n;
    ...
    var h2 = n || makeData(n);
    return "string" == typeof o ? readSelection(e2, o, i3, h2) : readSelection(e2, a, i3, h2, o);
  } else {
...
var resolveLink = (e2, r3, t, a, i3, n, o) => {
  if (Array.isArray(r3)) {
    var { store: s } = e2;
    var l3 = s.schema ? isListNullable(s.schema, t, a, e2.store.logger) : false;
    var v4 = makeData(n, true);
    var d5 = e2.partial;
    var u4 = V || !Array.isArray(n) || r3.length !== n.length;
    for (var c3 = 0, p5 = r3.length; c3 < p5; c3++) {
      e2.__internal.path.push(c3);
      var f4 = resolveLink(e2, r3[c3], t, a, i3, null != n ? n[c3] : void 0, o);
      e2.__internal.path.pop();
      if (void 0 === f4 && !l3) {
        e2.partial = d5;
        return;
      } else {
        e2.partial = e2.partial || void 0 === f4 && l3;
        v4[c3] = f4 || null;
        u4 = u4 || v4[c3] !== n[c3];
      }
    }
...
var _write = (e2, t, a, i3) => {
  ...
  var l3 = e2.rootFields[o.operation];
  var v4 = makeContext(e2, normalizeVariables(o, t.variables), getFragments(n), l3, l3, i3);
  if (true) {
    pushDebugNode(l3, o);
  }
  writeSelection(v4, l3, getSelectionSet(o), s.data);
  if (true) {
    popDebugNode();
  }
  return s;
...
var writeSelection = (e2, r3, t, a) => {
  var i3 = e2.store.rootNames[r3] || "query";
  ...
  var l3 = makeSelectionIterator(o, r3 || o, false, void 0, t, e2);
  var v4;
  while (v4 = l3()) {
    var d5 = getName(v4);
    var u4 = getFieldArguments(v4, e2.variables);
    var c3 = keyOfField(d5, u4);
    var p5 = getFieldAlias(v4);
    var f4 = a[e2.optimistic ? d5 : p5];
    if ("__typename" === d5 || void 0 === f4 && (T || e2.optimistic && "query" === i3)) {
      continue;
    }
    if (true) {
      if (e2.store.schema && o && "__typename" !== d5) {
        isFieldAvailableOnType(e2.store.schema, o, d5, e2.store.logger);
      }
    }
    e2.__internal.path.push(p5);
    var y4 = void 0;
    if (e2.optimistic && "mutation" === i3) {
      if (!(y4 = e2.store.optimisticMutations[d5])) {
        continue;
      }
    } else if (e2.optimistic && "function" == typeof f4) {
      y4 = f4;
    }
    if (y4) {
      updateContext(e2, a, o, r3 || o, c3, d5);
      f4 = ensureData(y4(u4 || {}, e2.store, e2));
    }
    if (void 0 === f4) {
      if (true) {
        if (!r3 || !hasField(r3, c3) || e2.optimistic && !readRecord(r3, "__typename")) {
          warn("Invalid undefined: The field at `" + c3 + "` is `undefined`, but the GraphQL query expects a " + (void 0 === v4.selectionSet ? "scalar (number, boolean, etc)" : "selection set") + " for this field.", 13, e2.store.logger);
        }
      }
      continue;
    }
    if (v4.selectionSet) {
      if (r3 && "query" === i3) {
        var h2 = joinKeys(r3, c3);
        var m2 = writeField(e2, getSelectionSet(v4), ensureData(f4), h2, e2.optimistic ? readLink(r3 || o, c3) : void 0);
        writeLink(r3 || o, c3, m2);
      } else {
        writeField(e2, getSelectionSet(v4), ensureData(f4));
      }
    } else if (r3 && "query" === i3) {
      writeRecord(r3 || o, c3, null !== f4 || !getFieldError(e2) ? f4 : void 0);
    }
    var g2 = s && s[d5];
    if (g2) {
      updateContext(e2, a, o, r3 || o, c3, d5);
...
var writeField = (e2, r3, t, a, i3) => {
  if (Array.isArray(t)) {
    var n = new Array(t.length);
    for (var o = 0, s = t.length; o < s; o++) {
      e2.__internal.path.push(o);
      var l3 = a ? joinKeys(a, `${o}`) : void 0;
      var v4 = writeField(e2, r3, t[o], l3, null != i3 ? i3[o] : void 0);
      n[o] = v4;
      e2.__internal.path.pop();
    }
    return n;
  ...
  var d5 = e2.store.keyOfEntity(t) || ("string" == typeof i3 ? i3 : null);
  var u4 = t.__typename;
  if (true) {
    if (a && !e2.store.keys[t.__typename] && null === d5 && "string" == typeof u4 && !K.test(u4)) {
      warn("Invalid key: The GraphQL query at the field at `" + a + "` has a selection set, but no key could be generated for the data at this field.\nYou have to request `id` or `_id` fields for all selection sets or create a custom `keys` config for `" + u4 + "`.\nEntities without keys will be embedded directly on the parent entity. If this is intentional, create a `keys` config for `" + u4 + "` that always returns null.", 15, e2.store.logger);
    }
  }
  var c3 = d5 || a;
  writeSelection(e2, c3, r3, t);
  return c3 || null;
};
var invalidateEntity = (e2, r3, t) => {
  ...
  for (var i3 = 0, n = a.length; i3 < n; i3++) {
    var { fieldKey: o } = a[i3];
...
var invalidateType = (e2) => {
  var r3 = ((e3) => w.types.get(e3) || q)(e2);
  for (var t of r3) {
    invalidateEntity(t);
  }
};
var Store = class {
        ...
        var t2 = {
          ...
          isSubType(e4, t3) {
            ...
            if (!a3 || !i5) {
              ...
              return !!a3.types()[t3];
            } else if ("OBJECT" !== a3.kind && "OBJECT" === i5.kind) {
              return !!i5.interfaces()[e4];
            } else {
              return e4 === t3;
            }
          }
    ...
    if (this.schema && true) {
      ...
      !function expectValidUpdatesConfig(e3, r4, t2) {
        ...
        for (var a2 in r4) {
          if (!r4[a2]) {
            ...
            return true ? warn("Invalid updates type: The type `" + a2 + "` is not an object in the defined schema, but the `updates` config is referencing it." + i4, 21, t2) : void 0;
          }
      ...
      !function expectValidResolversConfig(e3, r4, t2) {
        ...
        for (var a2 in r4) {
          if ("Query" === a2) {
            if (e3.query) {
              var i4 = e3.types.get(e3.query).fields();
      ...
      !function expectValidOptimisticMutationsConfig(e3, r4, t2) {
        ...
        if (e3.mutation) {
          ...
          for (var i4 in r4) {
            if (true) {
              if (!a2[i4]) {
                warn(`Invalid optimistic mutation field: \`${i4}\` is not a mutation field in the defined schema, but the \`optimistic\` option is referencing it.`, 24, t2);
              }
            }
          }
        }
  ...
  resolve(e2, r3, t) {
    ...
    if (a) {
      var i3 = keyOfField(r3, t);
      var n = readRecord(a, i3);
      if (void 0 !== n) {
        return n;
      }
      var o = readLink(a, i3);
  ...
  updateQuery(e2, r3) {
    ...
    var i3 = r3(this.readQuery(a));
    if (null !== i3) {
      _write(this, a, i3, void 0);
    }
  }
  readQuery(e2) {
  ...
  readFragment(e2, t, a, i3) {
    return ((e3, r3, t2, a2, i4) => {
      var n = getFragments(r3);
      var o;
      if (i4) {
        if (!(o = n[i4])) {
          warn("readFragment(...) was called with a fragment name that does not exist.\nYou provided " + i4 + " but could only find " + Object.keys(n).join(", ") + ".", 6, e3.logger);
          return null;
        }
      ...
      var v4 = makeContext(e3, a2 || {}, n, s, l3, void 0);
      var d5 = readSelection(v4, l3, getSelectionSet(o), makeData()) || null;
      if (true) {
        popDebugNode();
      }
      return d5;
    })(this, formatDocument(e2), t, a, i3);
  }
  writeFragment(e2, t, a, i3) {
    ((e3, r3, t2, a2, i4) => {
      var n = getFragments(r3);
      var o;
      if (i4) {
        if (!(o = n[i4])) {
          warn("writeFragment(...) was called with a fragment name that does not exist.\nYou provided " + i4 + " but could only find " + Object.keys(n).join(", ") + ".", 11, e3.logger);
          return null;
        }
      } else if (!(o = n[Object.keys(n)[0]])) {
      ...
      var d5 = makeContext(e3, a2 || {}, n, s, v4, void 0);
      writeSelection(d5, v4, getSelectionSet(o), l3);
      if (true) {
        popDebugNode();
      }
    })(this, formatDocument(e2), t, a, i3);
  ...
  link(e2, r3, ...t) {
    ...
    var i3 = 2 === t.length ? t[1] : t[0];
    var n = this.keyOfEntity(e2);
    if (n) {
      writeLink(n, keyOfField(r3, a), ensureLink(this, i3));
    }
  }
};
...
var cacheExchange = (e2) => ({ forward: t, client: i3, dispatchDebug: n }) => {
  var o = new Store(e2);
  if (e2 && e2.storage) {
          ...
          if (void 0 !== i4) {
            ...
            if (":" === i4[0]) {
              if (void 0 === readLink(n2, o2)) {
                writeLink(n2, o2, JSON.parse(i4.slice(1)));
              }
            } else if (void 0 === readRecord(n2, o2)) {
              writeRecord(n2, o2, JSON.parse(i4));
            }
          }
        }
        e3.storage = r4;
    ...
    for (var a of r3.values()) {
      if (a !== e3.key) {
        ...
        if (n2) {
          ...
          i3.reexecuteOperation(toRequestPolicy(n2, o2));
        }
      }
    }
    if (!t2) {
  ...
  var prepareForwardedOperation = (e3) => {
    ...
    if ("query" === e3.kind) {
      ...
      var { dependencies: i4 } = _write(o, e3, void 0, void 0);
      clearDataState();
      if (i4.size) {
        for (var n2 of i4.values()) {
          g2.add(n2);
        }
        f4.set(e3.key, i4);
        var s = /* @__PURE__ */ new Set();
        collectPendingOperations(s, i4);
  ...
  var updateCacheWithResult = (e3, r3) => {
    ...
    if (n2) {
      ...
      var l3 = "query" === t2.kind ? m2.get(t2.key) : null;
      initDataState("read", o.data, t2.key, false, l3 !== n2);
      var v4 = _query(o, t2, l3 || n2, e3.error);
      clearDataState();
      n2 = v4.data;
      if ("query" === t2.kind) {
        collectPendingOperations(r3, i4 = v4.dependencies);
        m2.set(t2.key, n2);
      }
    } else {
    ...
    if (i4) {
      updateDependencies2(e3.operation, i4);
    }
    return {
      operation: t2,
      data: n2,
  ...
  return (e3) => {
    ...
    var N3 = map2((e4) => {
      ...
      var a2 = "cache-only" !== r4 && (t2 || "partial" === e4.outcome && k2.has(e4.operation.key) && ((s = o.data).commutativeKeys.has(l3 = e4.operation.key) || s.optimisticOrder.indexOf(l3) > -1));
      var s, l3;
      var v4 = {
      ...
      if (!t2) {
        ...
        i3.reexecuteOperation(toRequestPolicy(h2.get(e4.operation.key) || e4.operation, "network-only"));
    ...
    var O2 = map2((e4) => {
      ...
      return t2;
    })(filter((e4) => !f4.has(e4.operation.key))(E3));
    var w2 = mergeMap((e4) => {
      if (y4.push(e4) < f4.size) {
        return empty;
      }
      for (var r4 = 0; r4 < y4.length; r4++) {
        reserveLayer(o.data, y4[r4].operation.key);
      }
      g2.clear();
      var t2 = [];
      var a2 = /* @__PURE__ */ new Set();
      var i4;
      while (i4 = y4.shift()) {
        t2.push(updateCacheWithResult(i4, a2));
      }
...
// node_modules/@urql/exchange-auth/node_modules/@urql/core/dist/urql-core-chunk.mjs
...
var CombinedError2 = class extends Error {
  constructor(e2) {
    var r3 = (e2.graphQLErrors || []).map(rehydrateGraphQlError);
    var t = ((e3, r4) => {
      var t2 = "";
      if (e3) {
...
var stringify2 = (e2, r3) => {
  if (null === e2 || i2.has(e2)) {
    return "null";
  } else if ("object" != typeof e2) {
    return JSON.stringify(e2) || "";
  } else if (e2.toJSON) {
    return stringify2(e2.toJSON(), r3);
  } else if (Array.isArray(e2)) {
    var t = "[";
    for (var a of e2) {
      if (t.length > 1) {
      ...
      t += stringify2(a, r3) || "null";
    }
    return t += "]";
  } else if (!r3 && (l2 !== NoopConstructor2 && e2 instanceof l2 || c2 !== NoopConstructor2 && e2 instanceof c2)) {
    return "null";
  }
  var o = Object.keys(e2).sort();
  if (!o.length && e2.constructor && Object.getPrototypeOf(e2).constructor !== Object.prototype.constructor) {
    var n = f3.get(e2) || Math.random().toString(36).slice(2);
    f3.set(e2, n);
    return stringify2({
      __key: n
    }, r3);
  ...
  var s = "{";
  for (var d5 of o) {
    var v4 = stringify2(e2[d5], r3);
    if (v4) {
      if (s.length > 1) {
        s += ",";
      }
      s += stringify2(d5, r3) + ":" + v4;
    }
  }
  i2.delete(e2);
  return s += "}";
};
var stringifyVariables2 = (e2, r3) => {
  i2.clear();
  return stringify2(e2, r3 || false);
};
var NoopConstructor2 = class {
};
var l2 = "undefined" != typeof File ? File : NoopConstructor2;
var c2 = "undefined" != typeof Blob ? Blob : NoopConstructor2;
var d2 = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g;
var v2 = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g;
var replaceOutsideStrings2 = (e2, r3) => r3 % 2 == 0 ? e2.replace(v2, "\n") : e2;
var sanitizeDocument2 = (e2) => e2.split(d2).map(replaceOutsideStrings2).join("").trim();
var p2 = /* @__PURE__ */ new Map();
var u2 = /* @__PURE__ */ new Map();
var stringifyDocument2 = (e2) => {
  var t;
  if ("string" == typeof e2) {
    t = sanitizeDocument2(e2);
  } else if (e2.loc && u2.get(e2.__key) === e2) {
    t = e2.loc.source.body;
  } else {
    t = p2.get(e2) || sanitizeDocument2(print(e2));
    p2.set(e2, t);
  }
  if ("string" != typeof e2 && !e2.loc) {
    e2.loc = {
...
var hashDocument2 = (e2) => {
  var r3;
  if (e2.documentId) {
    r3 = phash2(e2.documentId);
  } else {
    r3 = phash2(stringifyDocument2(e2));
    if (e2.definitions) {
      var t = getOperationName2(e2);
      if (t) {
        r3 = phash2(`
# ${t}`, r3);
      }
...
var keyDocument2 = (e2) => {
  ...
  if ("string" == typeof e2) {
    r3 = hashDocument2(e2);
    a = u2.get(r3) || parse(e2, {
      noLocation: true
    });
  } else {
    r3 = e2.__key || hashDocument2(e2);
    a = u2.get(r3) || e2;
  }
  if (!a.loc) {
    stringifyDocument2(a);
  }
  a.__key = r3;
  u2.set(r3, a);
  return a;
};
var createRequest2 = (e2, r3, t) => {
  var a = r3 || {};
  var o = keyDocument2(e2);
  var n = stringifyVariables2(a, true);
  var s = o.__key;
  if ("{}" !== n) {
    s = phash2(n, s);
  }
...
var makeErrorResult2 = (e2, r3, t) => ({
  operation: e2,
  data: void 0,
  error: new CombinedError2({
    networkError: r3,
    response: t
  }),
  extensions: void 0,
...
// node_modules/@urql/exchange-auth/node_modules/@urql/core/dist/urql-core.mjs
function makeOperation2(e2, r3, t) {
  return {
    ...r3,
    kind: e2,
    context: r3.context ? {
...
var addAuthAttemptToOperation = (t, e2) => makeOperation2(t.kind, t, {
  ...t.context,
  authAttempt: e2
});
function authExchange(s) {
  return ({ client: f4, forward: d5 }) => {
    ...
    return (t) => {
      function initAuth() {
        v4 = Promise.resolve().then(() => s({
          mutate(t2, n, r3) {
            var u4 = f4.createRequestOperation("mutation", createRequest2(t2, n), r3);
            return toPromise(take(1)(filter((t3) => t3.operation.key === u4.key && u4.context._instance === t3.operation.context._instance)(onStart(() => {
              var t3 = addAuthToOperation(u4);
              l3.add(t3.context._instance);
              p5.next(t3);
            })(E2))));
          },
          appendHeaders(t2, e2) {
            var n = "function" == typeof t2.context.fetchOptions ? t2.context.fetchOptions() : t2.context.fetchOptions || {};
            return makeOperation2(t2.kind, t2, {
              ...t2.context,
              fetchOptions: {
                ...n,
                headers: {
      ...
      function refreshAuth(t2) {
        ...
        if (w2 && !v4) {
          v4 = w2.refreshAuth().then(flushQueue).catch(errorQueue);
        }
      }
      ...
      var h2 = filter(Boolean)(map2((t2) => {
        if ("teardown" === t2.kind) {
          A2.delete(t2.key);
          return t2;
        } else if (t2.context._instance && l3.has(t2.context._instance)) {
          return t2;
      ...
      return merge([x2.source, filter((t2) => {
        if (!l3.has(t2.operation.context._instance) && t2.error && function didAuthError(t3) {
        ...
        if (l3.has(t2.operation.context._instance)) {
          l3.delete(t2.operation.context._instance);
        }
        return true;
      })(E2)]);
    };
...
// node_modules/@urql/exchange-persisted/node_modules/@urql/core/dist/urql-core-chunk.mjs
var d3 = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g;
var v3 = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g;
var replaceOutsideStrings3 = (e2, r3) => r3 % 2 == 0 ? e2.replace(v3, "\n") : e2;
var sanitizeDocument3 = (e2) => e2.split(d3).map(replaceOutsideStrings3).join("").trim();
var p3 = /* @__PURE__ */ new Map();
var u3 = /* @__PURE__ */ new Map();
var stringifyDocument3 = (e2) => {
  var t;
  if ("string" == typeof e2) {
    t = sanitizeDocument3(e2);
  } else if (e2.loc && u3.get(e2.__key) === e2) {
    t = e2.loc.source.body;
  } else {
    t = p3.get(e2) || sanitizeDocument3(print(e2));
    p3.set(e2, t);
  }
  if ("string" != typeof e2 && !e2.loc) {
    e2.loc = {
...
// node_modules/@urql/exchange-persisted/node_modules/@urql/core/dist/urql-core.mjs
function makeOperation3(e2, r3, t) {
  return {
    ...r3,
    kind: e2,
    context: r3.context ? {
...
var d4 = "undefined" != typeof window ? window.crypto : "undefined" != typeof self ? self.crypto : null;
var p4;
var hash = async (e2) => {
  if (d4 && d4.subtle) {
    var r3 = await d4.subtle.digest({
      name: "SHA-256"
    ...
    if (!p4) {
      try {
        p4 = new Function("require", 'return require("crypto")')(__require);
      } catch (e3) {
        try {
          p4 = new Function('return import("crypto")')();
        } catch (e4) {
        }
      }
    }
    ...
    return (await p4).createHash("sha256").update(e2).digest("hex");
  }
  if (true) {
...
var persistedExchange = (d5) => ({ forward: p5 }) => {
  if (!d5) {
    d5 = {};
  }
  var c3 = d5.preferGetForPersistedQueries;
  var y4 = !!d5.enforcePersistedQueries;
  var f4 = d5.generateHash || hash;
  var h2 = !!d5.enableForMutation;
  var l3 = !!d5.enableForSubscriptions;
  var x2 = true;
  var operationFilter = (e2) => x2 && !e2.context.persistAttempt && (h2 && "mutation" === e2.kind || l3 && "subscription" === e2.kind || "query" === e2.kind);
  return (d6) => {
    var h3 = makeSubject();
    var l4 = filter((e2) => !operationFilter(e2))(d6);
    var v4 = mergeMap((e2) => {
      var t = (async (e3) => {
        var r3 = makeOperation3(e3.kind, e3, {
          ...e3.context,
          persistAttempt: true
        });
        var t2 = await f4(stringifyDocument3(e3.query), e3.query);
        if (t2) {
          r3.extensions = {
            ...r3.extensions,
            persistedQuery: {
      ...
      return takeUntil(filter((r3) => "teardown" === r3.kind && r3.key === e2.key)(d6))(fromPromise(t));
    })(filter(operationFilter)(d6));
    return filter((e2) => !!e2)(map2((e2) => {
      if (!y4 && e2.operation.extensions && e2.operation.extensions.persistedQuery) {
        if (e2.error && e2.error.graphQLErrors.some((e3) => "PersistedQueryNotSupported" === e3.message)) {
          x2 = false;
          var r3 = makeOperation3(e2.operation.kind, e2.operation);
          if (r3.extensions) {
          ...
          var t = makeOperation3(e2.operation.kind, e2.operation);
          t.extensions = {
            ...t.extensions,
            persistedQuery: {
...
var concatEdges = (e2, r3, a) => {
  ...
  var f4 = r3.slice();
  for (var i3 = 0, v4 = a.length; i3 < v4; i3++) {
    var l3 = a[i3];
    var u4 = e2.resolve(l3, "node");
    if ("string" == typeof u4 && !n.has(u4)) {
      n.add(u4);
      f4.push(l3);
    }
  }
...
var concatNodes = (e2, r3) => {
  ...
  var o = e2.slice();
  for (var f4 = 0, i3 = r3.length; f4 < i3; f4++) {
    var v4 = r3[f4];
    if ("string" == typeof v4 && !a.has(v4)) {
      a.add(v4);
      o.push(v4);
    }
  }
...
var getPage = (e2, a, n) => {
  ...
  var v4 = e2.resolve(t, "pageInfo");
  if ("string" == typeof v4) {
    var l3 = ensureKey(e2.resolve(v4, "__typename"));
    var u4 = ensureKey(e2.resolve(v4, "endCursor"));
    var g2 = ensureKey(e2.resolve(v4, "startCursor"));
    var p5 = e2.resolve(v4, "hasNextPage");
    var d5 = e2.resolve(v4, "hasPreviousPage");
    var y4 = i3.pageInfo = {
      __typename: "string" == typeof l3 ? l3 : "PageInfo",
      hasNextPage: "boolean" == typeof p5 ? p5 : !!u4,
      hasPreviousPage: "boolean" == typeof d5 ? d5 : !!g2,
      endCursor: u4,
      startCursor: g2
    };
    if (null === y4.endCursor) {
      var m2 = o[o.length - 1];
      if (m2) {
        var h2 = e2.resolve(m2, "cursor");
        y4.endCursor = ensureKey(h2);
      }
    }
    if (null === y4.startCursor) {
      var _2 = o[0];
      if (_2) {
        var c3 = e2.resolve(_2, "cursor");
        y4.startCursor = ensureKey(c3);
      }
    }
  }
  return i3;
...
var relayPagination = (e2 = {}) => {
  ...
  return (e3, n, t, s) => {
    var { parentKey: o, fieldName: f4 } = s;
    var i3 = t.inspectFields(o).filter((e4) => e4.fieldName === f4);
    var v4 = i3.length;
    if (0 === v4) {
      return;
    }
    ...
    for (var m2 = 0; m2 < v4; m2++) {
      var { fieldKey: h2, arguments: _2 } = i3[m2];
      ...
      if (0 === c3.nodes.length && 0 === c3.edges.length && l3) {
        continue;
      }
      if ("inwards" === a && "number" == typeof _2.last && "number" == typeof _2.first) {
        var P = c3.edges.slice(0, _2.first + 1);
        var C = c3.edges.slice(-_2.last);
        var I3 = c3.nodes.slice(0, _2.first + 1);
        var b2 = c3.nodes.slice(-_2.last);
        u4 = concatEdges(t, u4, P);
        g2 = concatEdges(t, C, g2);
        p5 = concatNodes(p5, I3);
        d5 = concatNodes(b2, d5);
        y4 = c3.pageInfo;
      } else if (_2.after) {
        u4 = concatEdges(t, u4, c3.edges);
        p5 = concatNodes(p5, c3.nodes);
        y4.endCursor = c3.pageInfo.endCursor;
        y4.hasNextPage = c3.pageInfo.hasNextPage;
      } else if (_2.before) {
        g2 = concatEdges(t, c3.edges, g2);
        d5 = concatNodes(c3.nodes, d5);
        y4.startCursor = c3.pageInfo.startCursor;
        y4.hasPreviousPage = c3.pageInfo.hasPreviousPage;
      ...
      if (c3.pageInfo.__typename !== y4.__typename) {
        y4.__typename = c3.pageInfo.__typename;
      }
      if (l3 !== c3.__typename) {
        l3 = c3.__typename;
      }
    ...
    return {
      __typename: l3,
      edges: "inwards" === a ? concatEdges(t, u4, g2) : concatEdges(t, g2, u4),
      nodes: "inwards" === a ? concatNodes(p5, d5) : concatNodes(d5, p5),
      pageInfo: {
        __typename: y4.__typename,
        endCursor: y4.endCursor,
        startCursor: y4.startCursor,
        hasNextPage: y4.hasNextPage,
        hasPreviousPage: y4.hasPreviousPage
      }
    };
  };
};
...
var NotFoundErrorBoundaryInner = class extends import_react16.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      notFound: false,
...
function useItemData(args) {
  ...
  const locationsForTreeKey = (0, import_react16.useMemo)(() => {
    var _args$slug8;
    return getDirectoriesForTreeKey(object2(args.schema), args.dirpath, (_args$slug8 = args.slug) === null || _args$slug8 === void 0 ? void 0 : _args$slug8.slug, args.format);
  }, [args.dirpath, args.format, args.schema, (_args$slug9 = args.slug) === null || _args$slug9 === void 0 ? void 0 : _args$slug9.slug]);
  const localTreeKey = (0, import_react16.useMemo)(() => getTreeKey(locationsForTreeKey, rootTree !== null && rootTree !== void 0 ? rootTree : /* @__PURE__ */ new Map()), [locationsForTreeKey, rootTree]);
  const tree = (0, import_react16.useMemo)(() => {
  ...
  return useData((0, import_react16.useCallback)(() => {
...
function CollectionPage(props) {
  ...
  if (!collectionConfig)
    notFound();
  const router = useRouter();
  const [searchTerm, setSearchTerm] = (0, import_react16.useState)((_URLSearchParams$get = new URLSearchParams(router.search).get("search")) !== null && _URLSearchParams$get !== void 0 ? _URLSearchParams$get : "");
  const setSearchTermFromForm = (0, import_react16.useCallback)((value) => {
    setSearchTerm(value);
...
function CollectionPageHeader(props) {
  ...
  const [searchVisible, setSearchVisible] = (0, import_react16.useState)(isAboveMobile);
...
function CollectionTable(props) {
  ...
  let [sortDescriptor, setSortDescriptor] = (0, import_react16.useState)({
    column: SLUG,
    direction: "ascending"
  });
  ...
  const entriesWithStatus = (0, import_react16.useMemo)(() => {
  ...
  const mainFiles = useData((0, import_react16.useCallback)(async () => {
  ...
  const entriesWithData = (0, import_react16.useMemo)(() => {
  ...
  const sortedItems = (0, import_react16.useMemo)(() => {
...
function findSingleReorderedElement(oldKeys, newKeys) {
  ...
  if (sortedOldKeys.join() !== sortedNewKeys.join())
    return;
  let reorderedKey;
  for (let i3 = 0; i3 < oldKeys.length; i3++) {
    if (oldKeys[i3] !== newKeys[i3]) {
      if (reorderedKey === newKeys[i3])
        continue;
      if (reorderedKey !== void 0)
        return;
      reorderedKey = oldKeys[i3];
    }
  }
  return reorderedKey;
}
function createGetPreviewPropsFromY(rootSchema, yMap, awareness) {
    ...
    array(schema2, onChange) {
      return {
        ...
        onChange(updater) {
          ...
          const newVals = updater.map((x2, i3) => {
            const key = newKeys[i3];
  ...
  const previewPropsFactories = {
    ...
    array(schema2, value, memoized, path, getInnerProp) {
      ...
      const props = {
        elements: arrayValue.map((val, i3) => {
          const key = keys[i3];
          ...
          const element = getOrInsert(memoized.inner, key, () => {
            const onChange = Object.assign((val2) => {
              ...
              yjs() {
                ...
                const i4 = keys2.indexOf(key);
                return memoized.rawOnChange.yjs().get(i4);
              }
            });
...
var AppSlugContext = (0, import_react16.createContext)(void 0);
var AppSlugProvider = AppSlugContext.Provider;
function InstallGitHubApp(props) {
  var _URL$searchParams$get;
  const router = useRouter();
  const appSlugFromContext = (0, import_react16.useContext)(AppSlugContext);
...
function ForkRepoDialog(props) {
  ...
  const appSlug = (0, import_react16.useContext)(AppSlugContext);
...
var HeaderBreadcrumbs = (0, import_react16.memo)((props) => (0, import_jsx_runtime18.jsx)(_Breadcrumbs, {
  flex: true,
  size: "medium",
  minWidth: "alias.singleLineWidth",
  children: props.items.map((item) => (0, import_jsx_runtime18.jsx)($c1d7fb2ec91bae71$export$6d08773d2e66f8f2, {
    href: item.href,
    children: item.label
  }, item.key))
}));
...
function Provider({
  ...
  const keystarRouter = (0, import_react16.useMemo)(() => ({
    navigate
  }), [navigate]);
  return (0, import_jsx_runtime18.jsxs)(ThemeProvider, {
    value: themeContext,
    children: [(0, import_jsx_runtime18.jsx)("meta", {
      name: "viewport",
      content: "width=device-width, initial-scale=1"
    }), (0, import_jsx_runtime18.jsxs)(KeystarProvider, {
      ...
      children: [(0, import_jsx_runtime18.jsx)(ClientSideOnlyDocumentElement, {}), (0, import_jsx_runtime18.jsx)("link", {
        ...
        value: (0, import_react16.useMemo)(() => createUrqlClient(config), [config]),
        children
...
function useUpsertItem(args) {
  ...
  const baseCommit = useBaseCommit();
  const branchInfo = (0, import_react16.useContext)(BranchInfoContext);
  const setTreeSha = useSetTreeSha();
  const [, mutate] = useMutation(createCommitMutation);
  const repoWithWriteAccess = (0, import_react16.useContext)(RepoWithWriteAccessContext);
  const appSlug = (0, import_react16.useContext)(AppSlugContext);
...
function useHasChanged(args) {
  const serialize = (0, import_react16.useCallback)(async (state) => {
  ...
  const initialFilesForUpdate = useData((0, import_react16.useCallback)(() => args.initialState === null ? null : serialize(args.initialState), [args.initialState, serialize]));
  const filesForUpdate = useData((0, import_react16.useCallback)(() => serialize(args.state), [serialize, args.state]));
  const hasChangedState = (0, import_react16.useMemo)(() => {
    if (initialFilesForUpdate.kind === "loaded" && filesForUpdate.kind === "loaded") {
      ...
      return !(0, import_fast_deep_equal.default)(a, b2);
    }
    return "unknown";
  }, [initialFilesForUpdate, filesForUpdate]);
  const [hasChanged, setHasChanged] = (0, import_react16.useState)(false);
...
function useYJsValue(schema2, type3) {
  ...
  const thing = (0, import_react16.useMemo)(() => {
    let lastVal = yjsToVal(schema2, yjsInfo.awareness, type3);
    return {
      getSnapshot: () => lastVal,
      subscribe: (cb) => {
        const handler = () => {
  ...
  }, [schema2, type3, yjsInfo.awareness]);
  return (0, import_react16.useSyncExternalStore)(thing.subscribe, thing.getSnapshot, thing.getSnapshot);
}
...
function ItemPageInner(props) {
  ...
  const schema2 = (0, import_react16.useMemo)(() => object2(collectionConfig.schema), [collectionConfig.schema]);
  const router = useRouter();
  const baseCommit = useBaseCommit();
  const currentBasePath = getCollectionItemPath(config, collection, itemSlug);
  const formatInfo = getCollectionFormat(config, collection);
  const branchInfo = useBranchInfo();
  const [forceValidation, setForceValidation] = (0, import_react16.useState)(false);
  const previewHref = (0, import_react16.useMemo)(() => {
  ...
  const onUpdate = (0, import_react16.useCallback)(async () => {
    if (isSavingDisabled)
      return false;
...
function LocalItemPage(props) {
  ...
  }, setState] = (0, import_react16.useState)({
  ...
  const previewProps = (0, import_react16.useMemo)(() => createGetPreviewProps(schema2, (stateUpdater) => {
    setState((state2) => ({
...
function CollabItemPage(props) {
  ...
  const previewProps = (0, import_react16.useMemo)(() => createGetPreviewPropsFromY(schema2, props.map, yjsInfo.awareness), [props.map, schema2, yjsInfo.awareness])(state);
  const slug = getSlugFromState(collectionConfig, state);
  const formatInfo = getCollectionFormat(props.config, props.collection);
  const hasChanged = useHasChanged({
    initialState,
...
function HeaderActions(props) {
  ...
  const stringFormatter = $fca6afa0e843324b$export$f12b703ca79dfbb1(l10nMessages);
  const [deleteAlertIsOpen, setDeleteAlertOpen] = (0, import_react16.useState)(false);
  const [duplicateAlertIsOpen, setDuplicateAlertOpen] = (0, import_react16.useState)(false);
  const menuActions = (0, import_react16.useMemo)(() => {
    let items = [{
      key: "reset",
      label: "Reset changes",
      // TODO: l10n
  ...
  const indicatorElement = (() => {
    ...
    if (hasChanged) {
      return isBelowDesktop ? (0, import_jsx_runtime18.jsx)(Box, {
  ...
  return (0, import_jsx_runtime18.jsxs)(Flex, {
    ...
    children: [(0, import_jsx_runtime18.jsx)(PresenceAvatars, {}), indicatorElement, (0, import_jsx_runtime18.jsx)(_ActionGroup, {
      buttonLabelBehavior: "hide",
      overflowMode: "collapse",
      prominence: "low",
      density: "compact",
      maxWidth: isBelowDesktop ? "element.regular" : void 0,
      items: menuActions,
...
function CreateBranchDuringUpdateDialog(props) {
  ...
  const [branchName, setBranchName] = (0, import_react16.useState)("");
  const [{
    error,
    fetching,
    data
...
function ItemPageWrapper(props) {
  ...
  if (!collectionConfig)
    notFound();
  const format = (0, import_react16.useMemo)(() => getCollectionFormat(props.config, props.collection), [props.config, props.collection]);
  const slugInfo = (0, import_react16.useMemo)(() => {
    return {
      slug: props.itemSlug,
      field: collectionConfig.slugField
    };
  }, [collectionConfig.slugField, props.itemSlug]);
  const draftData = useData((0, import_react16.useCallback)(async () => {
  ...
  const mapData = useData((0, import_react16.useCallback)(() => {
    if (!yjsInfo)
      return;
    if (yjsInfo === "loading")
      return LOADING;
...
var ItemPageShell = (props) => {
  ...
  const breadcrumbItems = (0, import_react16.useMemo)(() => [{
    key: "collection",
  ...
  return (0, import_jsx_runtime18.jsxs)(PageRoot, {
    ...
    children: [(0, import_jsx_runtime18.jsxs)(PageHeader, {
      children: [(0, import_jsx_runtime18.jsx)(HeaderBreadcrumbs, {
...
function CreateItemWrapper(props) {
  var _props$config$collect;
  const router = useRouter();
  const duplicateSlug = (0, import_react16.useMemo)(() => {
  ...
  const slug = (0, import_react16.useMemo)(() => {
    if (duplicateSlug) {
      return {
        field: collectionConfig.slugField,
        slug: duplicateSlug
  ...
  const duplicateInitalStateWithUpdatedSlug = (0, import_react16.useMemo)(() => {
  ...
  const mapData = useData((0, import_react16.useCallback)(async () => {
    if (!yjsInfo)
      return;
    if (yjsInfo === "loading")
      return LOADING;
...
function CreateItemLocal(props) {
  ...
  if (!collectionConfig)
    notFound();
  const schema2 = (0, import_react16.useMemo)(() => object2(collectionConfig.schema), [collectionConfig.schema]);
  const initialState = (0, import_react16.useMemo)(() => {
  ...
  const [state, setState] = (0, import_react16.useState)((_props$draft$state = (_props$draft = props.draft) === null || _props$draft === void 0 ? void 0 : _props$draft.state) !== null && _props$draft$state !== void 0 ? _props$draft$state : initialState);
  const previewProps = (0, import_react16.useMemo)(() => createGetPreviewProps(schema2, setState, () => void 0), [schema2])(state);
  (0, import_react16.useEffect)(() => {
...
function CreateItemInner(props) {
  ...
  const schema2 = (0, import_react16.useMemo)(() => object2(collectionConfig.schema), [collectionConfig]);
  const [forceValidation, setForceValidation] = (0, import_react16.useState)(false);
...
function BranchSection() {
  ...
  return (0, import_jsx_runtime18.jsxs)(DashboardSection, {
    ...
    children: [(0, import_jsx_runtime18.jsxs)(Flex, {
      ...
      }), !isDefaultBranch && prNumber !== void 0 && (prNumber === false ? (0, import_jsx_runtime18.jsxs)(ActionButton, {
  ...
  return (0, import_jsx_runtime18.jsxs)(PageRoot, {
    ...
    children: [(0, import_jsx_runtime18.jsx)(PageHeader, {
      ...
      children: (0, import_jsx_runtime18.jsxs)(Flex, {
        ...
        }), !isLocalConfig(props.config) && (0, import_jsx_runtime18.jsx)(BranchSection, {}), (0, import_jsx_runtime18.jsx)(DashboardCards, {})]
      })
    })]
  });
}
    ...
    children: (0, import_jsx_runtime18.jsx)(AppStateContext.Provider, {
      ...
      children: (0, import_jsx_runtime18.jsx)(SidebarProvider, {
        children: (0, import_jsx_runtime18.jsx)(MainPanelLayout, {
          children: (0, import_jsx_runtime18.jsx)(BranchNotFound, {
            children: content
          })
        })
      })
...
function SingletonPageInner(props) {
  ...
  const branchInfo = useBranchInfo();
  const [forceValidation, setForceValidation] = (0, import_react16.useState)(false);
  const schema2 = (0, import_react16.useMemo)(() => object2(singletonConfig.schema), [singletonConfig.schema]);
  const router = useRouter();
  const previewHref = (0, import_react16.useMemo)(() => {
  ...
  return (0, import_jsx_runtime18.jsxs)(PageRoot, {
    ...
    children: [(0, import_jsx_runtime18.jsxs)(PageHeader, {
      ...
      }), (0, import_jsx_runtime18.jsx)(PresenceAvatars, {}), (0, import_jsx_runtime18.jsx)(_ActionGroup, {
        buttonLabelBehavior: "hide",
        overflowMode: "collapse",
        prominence: "low",
        density: "compact",
...
function SingletonPageWrapper(props) {
  ...
  const format = (0, import_react16.useMemo)(() => getSingletonFormat(props.config, props.singleton), [props.config, props.singleton]);
...
function KeystaticSetup(props) {
  const [deployedURL, setDeployedURL] = (0, import_react16.useState)("");
  const [organization, setOrganization] = (0, import_react16.useState)("");
  return (0, import_jsx_runtime18.jsx)(Flex, {
    alignItems: "center",
    justifyContent: "center",
    margin: "xxlarge",
...
function KeystaticCloudAuthCallback({
  ...
  const storedState = (0, import_react16.useMemo)(() => {
...
function RedirectToBranch(props) {
  ...
  const {
    data,
    error
  } = (0, import_react16.useContext)(GitHubAppShellDataContext);
  (0, import_react16.useEffect)(() => {
...
function AuthWrapper(props) {
  const [state, setState] = (0, import_react16.useState)("unknown");
  const router = useRouter();
  (0, import_react16.useEffect)(() => {
...
*/
//# sourceMappingURL=chunk-2WIRGPL7.js.map
